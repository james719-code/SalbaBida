...
fun AboutScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                text = "SALBA-bida is a flood disaster management application designed to help communities in the Philippines prepare for, respond to, and recover from flood events.",
                style = MaterialTheme.typography.bodyMedium,
